...
import { StartAppResponse, GetLogsResponse, CaptureAndroidScreenResponse, TerminateAppResponse, RestartAppResponse, ResetAppDataResponse, DeviceInfo, GetUITreeResponse, UIElement } from "./types.js"
...
export async function getAndroidUITree(deviceId?: string): Promise<GetUITreeResponse> {
